...
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.diegocaballero.sunshine";
    ...
    public static final class LocationEntry implements BaseColumns {
        public static final Uri CONTENT_URI = BASE_CONTENT_URL.buildUpon().appendPath(LOCATION_PATH).build();
